...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% More control over page headings
...
\makeatletter
\fancyhead[L]{\leftmark}                                 % The part name
\fancyhead[R]{\nouppercase{\if@mainmatter\rightmark\fi}} % The chapter name
\fancyfoot[C]{\thepage}                                  % The page number
\makeatother
