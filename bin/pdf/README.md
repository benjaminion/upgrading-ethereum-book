...
Get a copy of `pandoc` from the [pandoc repo](https://github.com/jgm/pandoc/releases/) and install it. It needs to be a fairly up to date one. (Caveat: Pandoc 3.8.2.0 fails due to [this issue](https://github.com/jgm/pandoc/issues/11201).)
